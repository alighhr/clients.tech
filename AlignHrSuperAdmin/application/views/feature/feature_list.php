...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
	...
	<div class="clearfix mt-2 mb-2">
		...
		<div class="float-right"><!-- ng-if="filterData.CategoryTypes.length>1" -->
			...
			<button class="btn btn-success btn-sm ml-1" ng-click="loadFormAdd();">Add <?php echo "Feature";?></button>
		</div>
	</div>
	<!-- Top container/ -->
					...
					<td class="text-center">
						<div class="dropdown action_toggle">
							...
							<div class="dropdown-menu dropdown-menu-left">
								<a class="dropdown-item" href="" ng-click="loadFormEdit(key, row.FeatureGUID)">Edit</a>
								<a class="dropdown-item" href="" ng-click="loadFormDelete(key, row.FeatureGUID)">Delete</a>
							</div>
						</div>
					</td>
				</tr>
	...
	<div class="modal fade" id="add_model">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title h5">Add <?php echo "Feature";?></h3>     	
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
	...
	<div class="modal fade" id="edit_model">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title h5">Edit Feature</h3>     	
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
