           ...
           <div class="row w-100 pt-4 m-0">
            <div class="col-lg-12  mb-4">
                <div class="panel_grp block" style="background-color: #fcb9a9;">
                   <div class="panel_title" style="background-color: #fcb9a9; font-weight: 900">Series:{{MatchWiseDataReports.Matches[0].MatchDetails.SeriesName}}  ({{MatchWiseDataReports.Matches[0].MatchDetails.SeriesStartDate}} - {{MatchWiseDataReports.Matches[0].MatchDetails.SeriesEndDate}} )</div>
