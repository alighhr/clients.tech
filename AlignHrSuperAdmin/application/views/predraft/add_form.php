	...
	<div class="form-area">
		...
		<form id="add_form" name="add_form" autocomplete="off" >
			...
			<div class="row">
				...
				<!-- <div class="col-md-3">
					<div class="form-group">
						<label class="filter-col" for="ParentCategory">Series</label>
                                                <select id="Series" name="RoundID" ng-model="RoundID" class="form-control chosen-select" ng-change="getRoundPlayers(RoundID)">
							<option value="">Please Select</option>
				...
				<input type="hidden" ng-model="ContestType" name="ContestType" value="Normal">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input name="ContestSize" ng-model="custom.ContestSize" type="numeric" class="form-control integer" min="4" max="8">
					</div>
				</div>
                ...
                <div class="col-md-3" ng-if="LeagueType == 'Draft'">
                    <div class="form-group">
                        ...
                        <input name="DraftPlayerSelectionCriteria[]" type="text" class="form-control numeric">
                ...
                <div class="col-md-3" ng-if="LeagueType == 'Draft'">
                    <div class="form-group">
                        ...
                        Total BOWL : {{filterDataRoundPlayers.Bowler}}
                          ...
                          <div class="col-md-12 text-success" ng-if="LeagueType == 'Draft'">Total Players:{{filterDataRoundPlayers.WicketKeeper + filterDataRoundPlayers.Batsman + filterDataRoundPlayers.AllRounder + filterDataRoundPlayers.Bowler}}</div>       
			</div>
