                ...
                <tbody>
                    <tr scope="row" ng-repeat="(key, row) in data.dataList">
                        <td class="listed sm clearfix table_list">
                            ...
                            <span class="user_table">{{row.FirstName}}</span>
                        </td>
                        <td class="listed sm clearfix">
                            <div ng-if="row.Email" class="user_table"><a href="mailto:{{row.Email}}" target="_top">{{row.Email}}</a></div><div ng-if="!row.Email">-</div>	
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group" ng-if="(row.Status == 'Processing' || row.Status == 'Pending') && row.PaymentGateway != 'Paytm'">
