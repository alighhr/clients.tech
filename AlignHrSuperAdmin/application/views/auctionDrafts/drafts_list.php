...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
	...
	<div class="clearfix mt-2 mb-2" >
		...
		<div class="float-right">
			<button class="btn theme_btn btn-secondary btn-sm ng-scope" ng-click="ExportExcel()">Export</button>

			<button ng-if="data.dataList.length" class="btn btn-default btn-secondary btn-sm ng-scope" data-toggle="modal" data-target="#filter_model"><img src="asset/img/filter.svg"></button>
			<!-- <button class="btn btn-success btn-sm ml-1" ng-click="loadFormAdd();">Add Contest</button> -->
			<a href="<?php echo base_url().'auctionDrafts/auctionDraftsAdd'?>" target="_blank" class="btn btn-success btn-sm ml-1" >Add Contest</a>
	...
	<div class="table-responsive block_pad_md" infinite-scroll="getList()" infinite-scroll-disabled='data.listLoading' infinite-scroll-distance="0"> 
		...
		<!-- data table -->
		<table id="DraftList" class="table table-striped table-condensed table-hover table-sortable" ng-if="data.dataList.length">
			<!-- table heading -->
			<thead>
				<tr>
          <th style="width: 100px;">League Type</th>
<!--          <th style="width: 100px;">Game Type</th>-->
					<th style="width: 250px;">Contest Name</th>
...
<!--					<th style="width: 70px;">Privacy</th>-->
					...
					<th style="width: 100px;" class="text-center">League Join Date</th>
					...
					<td class="text-center">
						<div class="dropdown" ng-if="row.Status=='Pending'">
							...
							<div class="dropdown-menu dropdown-menu-left">
								<a class="dropdown-item" target="_blank" href="<?php echo base_url().'auctionDrafts/auctionDraftsEdit'?>?ContestGuid={{row.ContestGUID}}">Edit</a>
								<!-- <a class="dropdown-item" ng-click="loadFormEdit(key, row.ContestGUID)">Edit</a>								 -->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="filter-col" for="StatusID">Active / Inactive</label>
