app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.loadFormList = function (Position, ContestGUID)
    {
        ...
        $http.post(API_URL_FOOTBALL+'admin/contest/getContestWinningUsers', 'SessionKey='+SessionKey+'&ContestGUID='+ContestGUID+'&Params=UserWinningAmount,TotalPoints,EntryFee,ContestSize,NoOfWinners,UserTeamName,FullName,UserRank', contentType).then(function(response) {
            var response = response.data;
