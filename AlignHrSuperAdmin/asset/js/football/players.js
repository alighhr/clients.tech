app.controller('PageController', function ($scope, $http, $timeout) {
    ...
    $scope.getList = function ()
    {
        ...
        if (getQueryStringValue('MatchGUID')) {
            ...
            var MatchGUID = getQueryStringValue('MatchGUID');
            var PlayerRole = 'TeamName,PlayerRole,IsActive,PlayerSalary,PlayerSalaryCredit';
            ...
            $scope.RoundIDAva = true;
             var ApiName = 'sports/getPlayers';
            var SeriesGUID = getQueryStringValue('SeriesGUID');
            var PlayerRole = 'TeamName,PlayerSalary,IsActive,PlayerRole,PlayerSalaryCredit';
        }
        ...
        $http.post(API_URL_FOOTBALL + ApiName, data, contentType).then(function (response) {
            var response = response.data;
    ...
    {   
        ...
        $http.post(API_URL_FOOTBALL + 'sports/getPlayer', 'PlayerGUID=' + PlayerGUID + '&MatchGUID='+ MatchGUID + '&Params=PlayerRole,IsActive,PlayerPic,PlayerCountry,PlayerBornPlace,PlayerBattingStyle,PlayerBowlingStyle,MatchType,MatchNo,MatchDateTime,SeriesName,TeamGUID&SessionKey=' + SessionKey, contentType).then(function (response) {
            var response = response.data;
    ...
    $scope.editData = function ()
    {
        ...
        $http.post(API_URL_FOOTBALL + UrlName, data, contentType).then(function (response) {
            var response = response.data;
            if (response.ResponseCode == 200) { /* success case */
