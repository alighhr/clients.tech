app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getList = function ()
    {
        ...
        var data = 'pageNo&StatusID=2&PointsCategory='+$scope.PointsCategory;
        $http.post(API_URL_FOOTBALL+'sports/getPoints', data, contentType).then(function(response) {
    ...
    $scope.editData = function (PointsTypeGUID,PointsMatchType,PointsValue)
    {
        ...
        $http.post(API_URL_FOOTBALL+'admin/points/update', data, contentType).then(function(response) {
            var response = response.data;
