app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getUserInfo = function(){
        ...
        $http.post(API_URL_FOOTBALL + 'users/getProfile', 'SessionKey=' + SessionKey + '&UserGUID=' + UserGUID + '&Params=Status,ProfilePic,MediaPAN,MediaBANK', contentType).then(function(response) {
            var response = response.data;
    ...
    $scope.getList = function ()
    {
        ...
        $http.post(API_URL_FOOTBALL+'admin/contest/getPrivateContest', data, contentType).then(function(response) {
        var response = response.data;
    ...
    $scope.loadContestJoinedUser = function (Position, ContestGUID)
    {
        ...
        $http.post(API_URL_FOOTBALL + 'contest/getJoinedContestsUsers', 'SessionKey=' + SessionKey + '&ContestGUID=' + ContestGUID + '&Params=UserTeamName,TotalPoints,UserWinningAmount,Email,PhoneNumber,FirstName,Username,UserGUID,UserTeamPlayers,UserTeamID,UserRank', contentType).then(function (response) {
            var response = response.data;
            if (response.ResponseCode == 200) { /* success case */
