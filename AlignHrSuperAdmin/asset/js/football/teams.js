app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getList = function ()
    {
        ...
        $http.post(API_URL_FOOTBALL+'sports/getTeams', data, contentType).then(function(response) {
            var response = response.data;
    ...
    $scope.loadFormEdit = function (Position, TeamGUID)
    {
        ...
        $http.post(API_URL_FOOTBALL+'sports/getTeam', 'TeamGUID='+TeamGUID+'&Params=TeamID,StatusID,TeamIDLive,TeamName,TeamNameShort,TeamFlag,Status', contentType).then(function(response) {
            var response = response.data;
    ...
    $scope.editData = function ()
    {
        ...
        console.log(data);
        $http.post(API_URL_FOOTBALL+'admin/teams/editTeam', data, contentType).then(function(response) {
            var response = response.data;
            if(response.ResponseCode==200){ /* success case */               
