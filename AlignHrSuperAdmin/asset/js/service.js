app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getList = function ()
    {
        ...
        var data = 'SessionKey='+SessionKey+'&PageNo='+$scope.data.pageNo+'&PageSize='+$scope.data.pageSize+ '&Params=Name,ServiceType,CategoryID,Description,Price,TimeDuration,VariablePrice,VariableTimeDuration&'+$('#filterForm').serialize();
        $http.post(API_URL+'service/getServices', data, contentType).then(function(response) {
            var response = response.data;
    ...
    /*load edit form*/
    $scope.loadFormEdit = function (Position, ServiceGUID)
    {
        $scope.getCategoriesList();
        $scope.getFeaturesList();
        ...
        $http.post(API_URL+'service/getService', 'SessionKey='+SessionKey+'&ServiceGUID='+ServiceGUID, contentType).then(function(response) {
            var response = response.data;
    ...
    /*load delete form*/
    $scope.loadFormDelete = function (Position, ServiceGUID)
    {
        $scope.data.Position = Position;
