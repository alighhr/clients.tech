app.controller('PageController', function ($scope, $http, $timeout, $rootScope) {
    ...
    $scope.getList = function (Type = '')
    {
        ...
        $http.post(API_URL + 'admin/PreAuctionContest/getPreContest', data, contentType).then(function (response) {
            var response = response.data;
    ...
    $scope.loadFormEdit = function (Position, PreContestID)
    {
        ...
        $http.post(API_URL + 'admin/PreAuctionContest/getPreContest', 'SessionKey=' + SessionKey + '&PreContestID=' + PreContestID + '&Params=WinningRatio,WinUpTo,LeagueType,UnfilledWinningPercent,SmartPool,IsVirtualUserJoined,VirtualUserJoinedPercentage,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,CustomizeWinning,ContestType,CashBonusContribution,UserJoinLimit,ContestFormat,IsConfirm,ShowJoinedContest,IsAutoCreate', contentType).then(function (response) {
            var response = response.data;
    ...
    $scope.addData = function ()
    {
        ...
        $http.post(API_URL + 'admin/PreAuctionContest/add', data, contentType).then(function (response) {
            var response = response.data;
            if (response.ResponseCode == 200) { /* success case */
                alertify.success(response.Message);
                $scope.applyFilter();
                window.location.href = 'predraft/preAuctionList';
            } else {
    ...
    $scope.editData = function ()
    {
        ...
        inputData.EntryFee = $scope.EntryFee;
        ...
        $http.post(API_URL + 'admin/PreAuctionContest/edit', $.param(inputData), contentType).then(function (response) {
    ...
    $scope.deleteContest = function (Position, PreContestID)
    {
        ...
        if (confirm('Are you sure, want to delete this Contest ?')) {
            $scope.addDataLoading = true;
            $http.post(API_URL + 'admin/PreAuctionContest/delete', 'SessionKey=' + SessionKey + '&PreContestID=' + PreContestID, contentType).then(function (response) {
                var response = response.data;
                if (response.ResponseCode == 200) { /* success case */
                    window.location.reload();
                    alertify.success(response.Message);
    ...
    $scope.deleteAllUpcomingContest = function (Position, PreContestID)
    {
        ...
        if (confirm('Are you sure, want to delete upcoming Pre contest ?')) {
            $scope.addDataLoading = true;
            $http.post(API_URL + 'admin/PreAuctionContest/deleteUpcomingPreContest', 'SessionKey=' + SessionKey + '&PreContestID=' + PreContestID, contentType).then(function (response) {
                var response = response.data;
                if (response.ResponseCode == 200) { /* success case */
                    alertify.success(response.Message);
                    setTimeout(function () {
