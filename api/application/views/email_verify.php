      ...
      <tr>
        <td>
          <table class="main-wrapper" width="610" border="0" cellspacing="0" cellpadding="0" align="center" style=" border-radius:5px;">
            <tr>
              <td colspan="2" class="content-padding" style="padding:40px 40px 20px; border-bottom:1px solid #E5E5E5;background:#FFFFFF;" >
                <p style="text-align: center; margin-bottom: 20px;"> 
                  <a style="outline:none;border:none;margin: 0 auto;" href="<?php echo SITE_HOST.''.ROOT_FOLDER;?>">
                ...
                <?php } ?>
                <p>Please click here to visit website <a href="<?php echo SITE_HOST.''.ROOT_FOLDER;?>"><?php echo SITE_HOST.''.ROOT_FOLDER;?></a> or download the app from <a href="<?php echo SITE_HOST.''.ROOT_FOLDER;?>download-fantasy-cricket-app"><?php echo SITE_HOST.''.ROOT_FOLDER;?>download-app</a></p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="center" style="font-family: 'Roboto', sans-serif; font-size:13px; color:#999999; padding:10px;background-color: #000;">Copyright &copy; <?php echo date('Y') ?> SuperStar11 Pvt. Ltd. All Rights Reserved.</td>
            </tr>
          </table>
        </td>
      </tr>
