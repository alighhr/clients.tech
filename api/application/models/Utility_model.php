...
class Utility_model extends CI_Model {
    ...
    function sendMobileSMS($SMSArray) {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_URL => SMS_API_URL."/sendmessage.php?user=" . SMS_API_USERNAME . "&password=" . SMS_API_PASSWORD . "&mobile=" . $SMSArray['PhoneNumber'] . "&message=" . $SMSArray['Text'] . "&sender=" . SMS_API_SENDER_ID . "&type=3",
