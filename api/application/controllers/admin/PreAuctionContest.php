...
class PreAuctionContest extends API_Controller_Secure {

    function __construct() {
        parent::__construct();
        $this->load->model('PreAuctionContest_model');
    ...
    public function add_post() {
        ...
        if (!$this->PreAuctionContest_model->addContest(array_merge($this->Post, array("DraftTeamPlayerLimit" => $this->Post['DraftTeamPlayerLimit'], "DraftPlayerSelectionCriteria" => json_encode($DraftPlayerSelectionCriteria))), $this->SessionUserID, $this->MatchID, $this->Post['RoundID'])) {
            $this->Return['ResponseCode'] = 500;
    ...
    public function edit_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Validation - ends */
        $this->PreAuctionContest_model->updateContest($this->Post, $this->SessionUserID, $this->PreContestID);
    ...
    public function getPreContestByType_post() {
        ...
        foreach ($ContestTypes as $key => $Contests) {
            ...
            array_push($ContestData, $this->PreAuctionContest_model->getPreContest(@$this->Post['Params'], array_merge($this->Post, array('UserID' => @$this->UserID, 'SessionUserID' => $this->SessionUserID), $Contests['Where']), TRUE, @$this->Post['PageNo'], @$this->Post['PageSize'])['Data']);
    ...
    public function getPreContest_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Get Contests Data */
        $ContestData = $this->PreAuctionContest_model->getPreContest(@$this->Post['Params'], array_merge($this->Post, array('PreContestID' => @$this->Post['PreContestID'], 'SessionUserID' => @$this->SessionUserID)), TRUE, @$this->Post['PageNo'], @$this->Post['PageSize']);
    ...
    public function delete_post() {
        ...
        $this->PreAuctionContest_model->deleteContest($this->SessionUserID, $this->Post['PreContestID']);
    ...
    public function deleteUpcomingPreContest_post() {
        ...
        $this->PreAuctionContest_model->deleteUpcomingPreContest($this->SessionUserID, $this->Post['PreContestID']);
        $this->Return['Message'] = "Contest deleted successfully.";
    }
