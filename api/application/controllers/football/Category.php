...
class Category extends API_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('football/Football_Category_model', 'Football_Category_model');
    }
    ...
    public function getAttributes_post() {
        ...
        $AttributesData = $this->Football_Category_model->getAttributes('
    ...
    public function getCategories_post() {
        ...
        $CategoryData = $this->Football_Category_model->getCategories('MenuOrder,SubCategoryNames', array("CategoryTypeID" => @$this->CategoryTypeID, "ParentCategoryID" => @$this->ParentCategoryID, "StoreID" => @$this->StoreID, "ShowOnlyParent" => (!empty($this->ParentCategoryID) ? false : true)), TRUE, @$this->Post['PageNo'], @$this->Post['PageSize']);
    ...
    public function getCategory_post() {
        ...
        $CategoryData = $this->Football_Category_model->getCategories('', array("CategoryTypeID" => @$this->CategoryTypeID, "CategoryID" => @$this->CategoryID));
        if (!empty($CategoryData)) {
