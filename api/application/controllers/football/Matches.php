...
class Matches extends API_Controller_Secure {
    ...
    public function changeStatus_post() {
        ...
        $this->Return['Data'] = $this->Football_Sports_model->getMatches('SeriesName,MatchType,MatchNo,MatchStartDateTime,TeamNameLocal,TeamNameVisitor,TeamNameShortLocal,TeamNameShortVisitor,TeamFlagLocal,TeamFlagVisitor,MatchLocation,Status', array('MatchID' => $this->MatchID), FALSE, 0);
    ...
    public function updatePlayerInfo_post() {
        ...
        /* Validation - ends */
        $this->Football_Sports_model->updatePlayerRole($this->PlayerID, $this->MatchID, array("PlayerRole" => $this->Post['PlayerRole'], 'IsAdminUpdate' => 'Yes'));
