...
class Config extends API_Controller_Secure {
    ...
    public function update_post() {
        ...
        $this->Football_Utility_model->updateConfig($this->Post['ConfigTypeGUID'], array_merge(array("StatusID" => $this->StatusID), $this->Post));
    ...
    public function bannerList_post() {
        $data = $this->Football_Utility_model->bannerList('', '', TRUE, @$this->Post['PageNo'], @$this->Post['PageSize']);
        if ($data) {
    ...
    public function addBanner_post() {
        ...
        $BannerData = $this->Football_Utility_model->addBanner($this->SessionUserID, array_merge($this->Post), $this->StatusID);
    ...
    public function addVersion_post() {
        ...
        $BannerData = $this->Football_Utility_model->addAppversion($this->SessionUserID, array_merge($this->Post), $this->StatusID);
