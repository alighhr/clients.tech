...
class Reports extends API_Controller_Secure {
    ...
    public function getMatchWiseReports_post() {
        ...
        $WinningUsersData = $this->Football_Contest_model->getMatchWiseReports(@$this->SeriesID, @$this->MatchID);
    ...
    public function getAccountReport_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Get Contests Winning Users Data */
        $WinningUsersData = $this->Football_Contest_model->getAccountReport($this->Post, @$this->SeriesID);
        if (!empty($WinningUsersData)) {
            $this->Return['Data'] = $WinningUsersData;
        }
    }
    ...
    public function getUserAnalysisReport_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Get Contests Winning Users Data */
        $WinningUsersData = $this->Football_Contest_model->getUserAnalysisReport($this->Post);
        if (!empty($WinningUsersData)) {
            $this->Return['Data'] = $WinningUsersData;
        }
    }
    ...
    public function getContestName_post() {
        $this->Return['Data'] = $this->Football_Contest_model->getContestName();
    }
    ...
    public function getContestAnalysisReport_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Get Contests Winning Users Data */
        $WinningUsersData = $this->Football_Contest_model->getContestAnalysisReport($this->Post, @$this->SeriesID, @$this->MatchID);
        if (!empty($WinningUsersData)) {
            $this->Return['Data'] = $WinningUsersData;
        }
    }
    ...
    public function getUserRegisterReport_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Get Contests Winning Users Data */
        $WinningUsersData = $this->Football_Contest_model->getUserRegisterReport($this->Post, @$this->SeriesID, @$this->MatchID);
        if (!empty($WinningUsersData)) {
            $this->Return['Data'] = $WinningUsersData;
        }
    }
    ...
    public function getUserJoinedFeeReport_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Get Contests Winning Users Data */
        $WinningUsersData = $this->Football_Contest_model->getUserJoinedFeeReport($this->Post, @$this->SeriesID, @$this->MatchID);
        if (!empty($WinningUsersData)) {
            $this->Return['Data'] = $WinningUsersData;
        }
    }
    ...
    public function getUserPlanningLifetimeReport_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Get Contests Winning Users Data */
        $WinningUsersData = $this->Football_Contest_model->getUserPlanningLifetimeReport($this->Post, @$this->SeriesID, @$this->MatchID);
        if (!empty($WinningUsersData)) {
            $this->Return['Data'] = $WinningUsersData;
        }
    }
