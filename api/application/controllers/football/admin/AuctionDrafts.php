...
class AuctionDrafts extends API_Controller_Secure {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('football/Football_AuctionDrafts_model', 'Football_AuctionDrafts_model');
    ...
    public function add_post() {
        ...
        if (!$this->Football_AuctionDrafts_model->addContest(array_merge($this->Post, array("DraftTeamPlayerLimit" => $this->Post['DraftTeamPlayerLimit'], "DraftPlayerSelectionCriteria" => json_encode($DraftPlayerSelectionCriteria))), $this->SessionUserID, $this->MatchID, $this->Post['RoundID'])) {
            $this->Return['ResponseCode'] = 500;
    ...
    public function edit_post() {
        ...
        $this->Football_AuctionDrafts_model->updateContest(array_merge($this->Post, array("DraftTeamPlayerLimit" => $this->Post['DraftTeamPlayerLimit'], "DraftPlayerSelectionCriteria" => $this->Post['DraftPlayerSelectionCriteria'])), $this->SessionUserID, $this->ContestID);
    ...
    public function getUserJoinedContests_post() {
        ...
        $JoinedContestData = $this->Football_AuctionDrafts_model->getJoinedContests(@$this->Post['Params'], array_merge($this->Post, array('SessionUserID' => @$this->UserID)), TRUE, @$this->Post['PageNo'], @$this->Post['PageSize']);
    ...
    public function getPrivateContest_post() {
        ...
        /* Get Contests Data */
        $ContestData = $this->Football_AuctionDrafts_model->getContests(@$this->Post['Params'], array_merge($this->Post, array('UserID' => $this->UserID)), TRUE, @$this->Post['PageNo'], @$this->Post['PageSize']);
    ...
    public function cancel_post() {
        ...
        /* Cancel Contests */
        $this->Football_AuctionDrafts_model->cancelContest(@$this->Post, $this->SessionUserID, $this->ContestID);
    ...
    public function validateContestStatus($ContestGUID) {
        $ContestData = $this->Football_AuctionDrafts_model->getContests('Status,IsPaid,SeriesName,ContestName,MatchNo,TeamNameLocal,TeamNameVisitor,EntryFee', array('ContestID' => $this->ContestID));
    ...
    public function getContestWinningUsers_post() {
        ...
        $WinningUsersData = $this->Football_AuctionDrafts_model->getContestWinningUsers(@$this->Post['Params'], array_merge($this->Post, array('ContestID' => $this->ContestID)), TRUE, @$this->Post['PageNo'], @$this->Post['PageSize']);
